...
public class DepthOfFieldSimulator {
    ...
    public static void simulateDepthOfField(String imagePath, String outputPath, int focusStart, int focusEnd) throws IOException, ImagingException {
        // Load the image
    ...
    public static void main(String[] args) {
        try {
            simulateDepthOfField("path/to/input/image.png", "path/to/output/image.png", 100, 300);
